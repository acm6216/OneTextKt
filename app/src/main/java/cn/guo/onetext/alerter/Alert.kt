package cn.guo.onetext.alerter
...
import cn.guo.onetext.alerter.utils.getDimenPixelSize
import cn.guo.onetext.alerter.utils.getRippleDrawable
import cn.guo.onetext.alerter.utils.notchHeight
...
class Alert @JvmOverloads constructor(context: Context,
                                      ...
                                      defStyle: Int = 0)
    : LinearLayout(context, attrs, defStyle), View.OnClickListener, Animation.AnimationListener, SwipeDismissTouchListener.DismissCallbacks {
