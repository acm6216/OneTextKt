package cn.guo.onetext.widget.doodle;
...
public class DrawingBoardView extends View {
    ...
    //画笔颜色
    private int mPaintColor = 0xff2196F3;
    //画笔宽度
    private int mPaintSize = dip2px(5);
    //橡皮擦宽度
    private int mEraserSize = mPaintSize;
    //缓冲的位图
    ...
    public void setPaintSize(int size){
        mEraserSize = mPaintSize = dip2px(size);
        mPaint.setStrokeWidth(mPaintSize);
    }
