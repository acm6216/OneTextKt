package cn.guo.onetext.widget.chatView;
 ...
 * https://github.com/bigdongdong/ChatView
 *
 */
...
public class ChatView extends ChatLayout {
     ...
     * nomal描边颜色，默认边框灰色
     */
    private int strokeColor = 0x00FFFFFF;

    /**
     * nomal内填充颜色，默认填充是淡蓝色
     */
    private int  fillColor = 0xFF66CCFF;
    ...
    public ChatView setHasStroke(boolean hasStroke) {
